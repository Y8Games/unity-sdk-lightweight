...
namespace Y8API
{
    ...
    private static extern void Call(int _id, string _request, string _jsonData);
        ...
        /// </summary>
        public async Task<JsResponse<Authorisation>> AutoLogin()
        {
            return await TryCall<Authorisation>("auto_login", null);
        }
        ...
        /// </summary>
        public async Task<JsResponse<Authorisation>> Register()
        {
            return await TryCall<Authorisation>("register", null);
        }
        ...
        /// </summary>
        public async Task<JsResponse<Authorisation>> Login()
        {
            return await TryCall<Authorisation>("login", null);
        }
        ...
        {
            await TryCall<Empty>("achievement_list", null);
        }
        ...
        public async Task<JsResponse<AchievementSave>> AchievementSave(string achievement, string achievementkey, bool overwrite = false, bool allowduplicates = false)
        {
            if (!IsLoggedIn())
            {
            ...
            return await TryCall<AchievementSave>("achievement_save", json);
        }
        ...
        /// </summary>
        public async Task<JsResponse<ScoreTables>> Tables()
        {
            return await TryCall<ScoreTables>("tables", null);
        }
        ...
        public async Task<JsResponse<ScoreTable>> CustomScore(string table, string mode = "alltime", int perPage = 20, int page = 1, bool highest = true, string playerid = "")
        {
            ...
            return await TryCall<ScoreTable>("custom_score", json.ToArray());
        }
        ...
        public async Task ScoreList(string tableTitle, string mode = "alltime", bool highest = true, bool useMilli = false)
        {
            List<KeyValuePair<string, string>> json = new List<KeyValuePair<string, string>> {
            ...
            await TryCall<Empty>("score_list", json.ToArray());
        }
        ...
        /// <param name="highest">(optional) (default: true) Set to false if a lower score is better.</param>
        public async Task<JsResponse<ScoreSave>> ScoreSave(string table, int points, bool allowduplicates = false, bool highest = true)
        {
            if (!IsLoggedIn())
            {
            ...
            return await TryCall<ScoreSave>("score_save", json.ToArray());
        }
        ...
        public async Task AppRequest(string message = "<message>", string redirect_uri = "", string data = "")
        {
            KeyValuePair<string, string>[] json = {
            ...
            await TryCall<Empty>("app_request", json);
        }
        ...
        public async Task FriendRequest(string _id, string redirect_uri = "")
        {
            KeyValuePair<string, string>[] json = {
            ...
            await TryCall<Empty>("friend_request", json);
        }
        ...
        public async Task Share(string link, string description, string name = "", string caption = "", string picture = "")
        {
            KeyValuePair<string, string>[] json = {
            ...
            await TryCall<Empty>("share", json);
        }
        ...
        public async Task<JsResponse<SetData>> SetData(string key, string value)
        {
            if (!IsLoggedIn())
            {
            ...
            return await TryCall<SetData>("set_data", json);
        }
        ...
        public async Task<JsResponse<GetData>> GetData(string key)
        {
            if (!IsLoggedIn())
            {
            ...
            return await TryCall<GetData>("get_data", json);
        }
        ...
        public async Task<JsResponse<SetData>> ClearData(string key)
        {
            if (!IsLoggedIn())
            {
            ...
            return await TryCall<SetData>("clear_data", json);
        }
        ...
        public async Task<JsResponse<bool>> IsBlacklisted()
        {
            return await TryCall<bool>("blacklist", null);
        }
        ...
        /// </summary>
        /// <returns>true if it is</returns>
        public async Task<JsResponse<bool>> IsSponsor()
        {
            return await TryCall<bool>("sponsor", null);
        }
        ...
        private async Task<JsResponse<T>> TryCall<T>(string requestName, KeyValuePair<string, string>[] kvPairs)
        {
            if (!isReady)
            {
